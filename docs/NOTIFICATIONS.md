...
Bei Kontosperre wird die Push-Zuordnung serverseitig gelöscht. Wenn ein Authentik-Gerät deaktiviert wird, abläuft, gelöscht wird, sein Connector deaktiviert ist oder der eindeutig gebundene persönliche Benutzer inaktiv wird, schlägt die Live-Prüfung fehl. Der automatische Abgleich sendet bei einer einzelnen Gerätesperre einmalig einen inhaltslosen Sicherheitsimpuls an genau dieses Gerät und entfernt nur dessen Bridge-Daten. Beim Mitarbeiter-Offboarding löscht er zusätzlich gespeicherte Ereignisse, Zustellungen, Nonces, Anmeldeanfragen und Talk-Übergaben für das gesamte Subject. Die App leert bei erkanntem Sperrstatus oder sicherer Abmeldung WebView-Cookies, Webspeicher, HTTP-Zugangsdaten, Cache, Downloads und lokale Hinweise.
