...
5. Erst nach diesem Test eine zweite Pilotversion veröffentlichen. Dann auf demselben Gerät prüfen, ob F-Droid das Update ohne erneute Installationsbestätigung übernimmt. Anschließend denselben Ablauf auf einem Samsung-Gerät prüfen.
